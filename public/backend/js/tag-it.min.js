...
(function (factory) {
    ...
    AmsifySuggestags.prototype = {
        ...
        setTagEvents: function () {
            ...
            $(this.selectors.sTagsInput).keyup(function (e) {
                ...
                if (key == "Enter" || key == "," || isDelimiter) {
                    ...
                    if (isDelimiter) {
                        $.each(
                            _self.settings.delimiters,
                            function (dkey, delimiter) {
        ...
        processAjaxSuggestion: function (value, keycode) {
            ...
            if (
                this.settings.suggestionsAction.dataType !== undefined &&
                this.settings.suggestionsAction.dataType !== null
            ) {
                ajaxFormParams["dataType"] =
                    this.settings.suggestionsAction.dataType;
            }
            ...
            if (keycode == "40" || keycode == "38") {
                ...
                this.delayTimer = setTimeout(function () {
                    if (_self.isSuggestAction() && !_self.ajaxActive) {
                        ...
                        var lastSearch =
                            _self.selectors.sTagsInput.attr("last-search");
                        if (
                    ...
                    if (typeof item === "object") {
                        if (item.value.toString().toLowerCase() == lower) {
                            ...
                            if (
                                ...
                                _self.settings.classes[key] === undefined
                            ) {
                                _self.settings.classes[key] = item.class;
                            }
                            if (
                                item.background !== undefined &&
                                _self.settings.backgrounds[key] === undefined
                            ) {
                                _self.settings.backgrounds[key] =
                                    item.background;
                            }
                            if (
                                item.color !== undefined &&
                                _self.settings.colors[key] === undefined
                            ) {
        ...
        flashItem: function (value, itemKey) {
            ...
            if ($tagItem) {
                background =
                    this.settings.backgrounds[itemKey] !== undefined
                        ? this.settings.backgrounds[itemKey]
                        : null;
                if (background !== null) {
